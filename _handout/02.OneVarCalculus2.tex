...
\begin{frame}[t]{Convexity and Concavity}
	\begin{defn}
		...
		\[
			f\left((1-t)\bar a + t \bar b \right)\le (1-t)f(\bar a)+ tf(\bar b),\quad \forall t\in [0,1]
		\]
		$f$ is concave on $(\bar a, \bar b)$ iff:
		\[
			f\left((1-t)\bar a + t \bar b \right) \ge (1-t)f(\bar a)+ tf(\bar b),\quad \forall t\in [0,1]
		\]
	\end{defn}
	\begin{center}
		\begin{tabular}{c|c|c}
